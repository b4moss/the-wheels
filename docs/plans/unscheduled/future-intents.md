...
- **Card / ContentSection** — JS よりスタイル・レイアウト。再開時期は未定
...
- **FV 画像差し替え** — 現行は `dev/apps/kitchen-sink/src/assets/img/main-visual.png`（ドライジーネ）。現行アセットのまま運用する
- **Accordion の高さ制限** — 要実装。v0.14.0 の展開小窓とは別。版が決まったら Accordion 仕様へ足す
